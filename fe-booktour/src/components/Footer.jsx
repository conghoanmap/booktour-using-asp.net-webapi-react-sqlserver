...
const Footer = (props) => {
  return (
    <footer className="bg-sky-50 font-quicksand">
        ...
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  Đăng kí để nhận những thông tin mới nhất
                </h2>

                <p className="mt-4 text-gray-500">
                  Đăng kí để nhận thông tin mới nhất về các tour du lịch, vé máy
                  bay, khách sạn và nhiều dịch vụ khác.
                </p>
              </div>
            </div>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-900">Thông tin</p>
