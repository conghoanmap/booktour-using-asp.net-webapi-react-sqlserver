...
const Header = (props) => {
  ...
  return (
    <header className="bg-sky-50 font-quicksand">
          ...
          <div className="md:flex md:items-center md:gap-12">
                ...
                {menuItems.map((item, index) => (
                  <li key={index}>
                    <Menu>
                      <MenuButton>
                        <Link
                          className="flex gap-1 font-semibold text-gray-500 transition hover:text-sky-700/75"
                          to={item.url}
                        >
                          {item.title}
                          {item.subMenu && (
            ...
            {!context.isAuthenticated ? (
              <div className="sm:flex sm:gap-4">
                ...
                <Link
                  className="hidden rounded-md bg-white px-5 py-2.5 text-sm font-medium text-sky-600 transition hover:text-sky-600/75 sm:block"
                  to="/register"
                >
                  Đăng kí
                </Link>
            ...
            <div
              className={`${
                context.isAuthenticated ? "block md:hidden" : "hidden"
              }`}
            >
